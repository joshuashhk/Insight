---
title: "大股东增减持"
source: "https://www.lixinger.com/open/api/doc?api-key=cn/company/major-shareholders-shares-change"
author:
published:
created: 2026-01-31
description:
...
| stockCode | No | String | 请参考[股票信息API](https://www.lixinger.com/open/api/detail?api-key=cn/company)获取合法的stockCode。stockCode仅在请求数据为date range的情况下生效。 |
